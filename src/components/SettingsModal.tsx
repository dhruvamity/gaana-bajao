...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div 
        className="w-full max-w-2xl bg-surface-container-high rounded-lg p-6 sm:p-8 shadow-card space-y-6 max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        {activeTab === 'firebase' && (
          <form onSubmit={handleSaveFirebase} className="space-y-4">
            <div className="p-3.5 rounded-lg bg-primary/10 border border-white/10 text-xs text-primary font-medium flex items-center gap-2">
            ...
            <div className="flex items-center justify-between pt-2">
              <button
                ...
                className="px-4 py-2 rounded bg-white/5 text-red-400 hover:bg-red-500/10 text-xs font-semibold flex items-center gap-1.5 transition-all"
              >
                <Trash2 size={14} />
